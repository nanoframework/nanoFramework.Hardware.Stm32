...
if ($env:APPVEYOR_REPO_TAG -eq "true")
{
    ...
    # new branch name
    $newBranch = "$env:APPVEYOR_REPO_BRANCH-nfbot/update-version/nanoFramework.Hardware.Stm32/$env:MyNuGetVersion"
    ...
    {
        $commitMessage = "Update nanoFramework.Hardware.Stm32 version to $env:MyNuGetVersion"
